...
public final class Profile {
    ...
    @Builder.Default public boolean compatibleWithClientSideChunkGen = true;
    ...
    @Builder.Default public String platformUserId = "";
    ...
    @Builder.Default public String skinGeometryData = EncodingUtils.base64Encode(
            ProfileUtils.SKIN_GEOMETRY_DATA.getBytes());
