...
// @generated from protobuf file "src/main/proto/Protocol.proto" (syntax proto3)
// tslint:disable
...
export interface Player {
    ...
    name: string;
    /**
     * @generated from protobuf field: Vector3 position = 2;
     */
    position?: Vector3;
    /**
     * @generated from protobuf field: Vector2 rotation = 3;
     */
    rotation?: Vector2;
    /**
     * @generated from protobuf field: Attributes attributes = 4;
     */
    attributes?: Attributes;
    /**
     * @generated from protobuf field: Inventory inventory = 5;
     */
    inventory?: Inventory;
}
/**
...
class Player$Type extends MessageType<Player> {
    constructor() {
        super("Player", [
            ...
            { no: 3, name: "rotation", kind: "message", T: () => Vector2 },
            { no: 4, name: "attributes", kind: "message", T: () => Attributes },
            { no: 5, name: "inventory", kind: "message", T: () => Inventory }
        ]);
    }
    ...
    internalBinaryWrite(message: Player, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* Vector3 position = 2; */
        if (message.position)
            Vector3.internalBinaryWrite(message.position, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* Vector2 rotation = 3; */
        if (message.rotation)
            Vector2.internalBinaryWrite(message.rotation, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* Attributes attributes = 4; */
        if (message.attributes)
            Attributes.internalBinaryWrite(message.attributes, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* Inventory inventory = 5; */
        if (message.inventory)
            Inventory.internalBinaryWrite(message.inventory, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
